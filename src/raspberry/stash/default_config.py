...
This constants are default, the current costants are in the file "parameters.json"
USE THIS FILE AS A GUIDE, THIS CONSTANTS ARE NOT BEING LOADED TO THE ROBOT
"""
